...
-- --Food
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Hawaiian Pizza', 'Pizza', 20, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Meat Lovers Pizza', 'Pizza', 20, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Mushroom Pizza', 'Pizza', 18, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Dessert Pizza', 'Pizza', 18, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Drumlets 6pc', 'Sides', 10, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Wings 6pc', 'Pizza', 10, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (1, 'Coca-Cola', 'Drinks', 2.70, 100, False);
insert into food(rid, name, category, price, food_limit, isRemoved) values (2, 'Ferrero Rocher', 'Chocolate', 1.10, 200, False);
