...
-- --Promos
insert into Promos (start_date, end_date, promo_type, discount) values ('01/04/2020', '01/06/2020', 0, 15);
insert into Promos (start_date, end_date, promo_type, discount) values ('01/04/2020', '01/07/2020', 1, 10);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('01/05/2020', '28/05/2020', 1, 21);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('01/05/2020', '01/06/2020', 0, 10);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('01/06/2020', '13/08/2020', 1, 5);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('17/05/2020', '25/05/2020', 1, 8);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('25/05/2020', '09/06/2020', 1, 7);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('12/06/2020', '19/06/2020', 1, 15);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('19/06/2020', '26/06/2020', 1, 20);
-- insert into Promos (start_date, end_date, promo_type, discount) values ('26/07/2020', '29/07/2020', 1, 40);
...
-- select NewOrder(4, '97550 Kipling Avenue', 1, 0, 0, '"265" => "5", "271" => "4", "276" => "3", "278" => "4"');
-- select NewOrder(36, '349 Montana Point', 3, 0, 0, '"178" => "2", "188" => "1"');
-- select NewOrder(64, '542 Northridge Center', 1, 0, 0, '"86" => "2", "88" => "1", "90" => "1", "92" => "1", "95" => "3"');
-- select NewOrder(157, '84379 Brown Plaza', 3, 1, 0, '"18" => "5", "22" => "5"');
-- select NewOrder(201, '4 Fairfield Street', 2, 1, 0, '"65" => "3", "66" => "1", "82" => "1", "85" => "2"');
-- select NewOrder(208, '3 Crownhardt Place', 1, 1, 0, '"322" => "3", "323" => "2", "326" => "2", "330" => "2", "334" => "1"');
-- select NewOrder(280, '74 Rowland Hill', 1, 1, 0, '"245" => "4"');
-- select NewOrder(314, '40505 Chinook Hill', 1, 1, 0, '"382" => "3", "385" => "2"');
-- select NewOrder(32, '29827 Fuller Trail', 2, 1, 0, '"40" => "3", "43" => "2", "45" => "2", "51" => "3"');
-- select NewOrder(78, '974 Maple Circle', 1, 1, 0, '"131" => "2", "150" => "3"');
-- select NewOrder(101, '135 Lighthouse Bay Parkway', 2, 1, 0, '"158" => "2", "160" => "1", "165" => "1", "169" => "2"');
-- select NewOrder(134, '950 Buell Road', 2, 0, 0, '"219" => "4"');
-- select NewOrder(162, '04 Evergreen Center', 3, 0, 0, '"114" => "3", "124" => "1", "128" => "3"');
-- select NewOrder(199, '70 Becker Way', 3, 1, 0, '"267" => "3", "268" => "2", "271" => "2", "272" => "2", "275" => "3", "278" => "2"');
-- select NewOrder(225, '8137 Katie Street', 1, 0, 0, '"336" => "2"');
-- select NewOrder(264, '19918 Mitchell Lane', 2, 0, 0, '"194" => "3", "196" => "1", "200" => "1"');
-- select NewOrder(297, '5 Ridgeway Trail', 2, 0, 0, '"39" => "8"');
-- select NewOrder(361, '74559 Waubesa Avenue', 3, 0, 0, '"55" => "3"');
-- select NewOrder(362, '45688 Golf Course Pass', 3, 0, 0, '"4" => "1", "6" => "2", "11" => "3"');
-- select NewOrder(26, '4034 Knutson Point', 3, 0, 0, '"378" => "2", "380" => "1"');
-- select NewOrder(14, '57 Waywood Drive', 1, 1, 0, '"66" => "2", "68" => "1", "71" => "1", "79" => "1"');
-- select NewOrder(189, '6 Cascade Crossing', 2, 0, 0, '"301" => "1", "302" => "1"');
-- select NewOrder(271, '4973 Hansons Junction', 2, 1, 0, '"230" => "6", "233" => "5", "242" => "4"');
-- select NewOrder(85, '885 Sunnyside Trail', 1, 0, 0, '"382" => "2", "384" => "1", "387" => "2", "392" => "1"');
-- select NewOrder(188, '8699 Nevada Crossing', 2, 1, 0, '"86" => "4"');
-- select NewOrder(126, '078 John Wall Way', 1, 0, 0, '"28" => "3", "30" => "1"');
-- select NewOrder(277, '01 Prairie Rose Pass', 1, 1, 0, '"219" => "2", "220" => "3"');
-- select NewOrder(160, '52590 Sunbrook Parkway', 2, 1, 0, '"99" => "2", "101" => "1", "102" => "1"');
-- select NewOrder(375, '36888 Summit Avenue', 3, 0, 0, '"322" => "4", "327" => "4"');
-- select NewOrder(98, '6 Doe Crossing Terrace', 3, 1, 0, '"300" => "3"');
-- select NewOrder(224, '79588 Ridgeway Plaza', 3, 0, 0, '"300" => "2", "301" => "1", "303" => "1", "306" => "1", "316" => "2"');
-- select NewOrder(324, '6566 Prentice Avenue', 3, 0, 0, '"368" => "4", "374" => "4"');
-- select NewOrder(130, '881 Ilene Parkway', 3, 1, 0, '"205" => "4", "208" => "3", "215" => "3"');
-- select NewOrder(288, '0 Blaine Court', 3, 1, 0, '"327" => "4", "330" => "3", "335" => "4"');
-- select NewOrder(139, '50 Buhler Drive', 3, 1, 0, '"131" => "3", "133" => "2", "142" => "1", "146" => "2", "154" => "4"');
-- select NewOrder(123, '798 Menomonie Parkway', 3, 0, 0, '"18" => "6"');
-- select NewOrder(286, '45 Michigan Court', 2, 0, 0, '"234" => "4", "239" => "4"');
-- select NewOrder(269, '22 8th Court', 1, 1, 0, '"210" => "5"');
-- select NewOrder(157, '84379 Brown Plaza', 2, 1, 0, '"337" => "2", "338" => "3", "345" => "2", "350" => "3"');
-- select NewOrder(76, '51949 Ryan Pass', 1, 1, 0, '"52" => "2", "55" => "2"');
-- select NewOrder(55, '5222 Homewood Point', 2, 0, 0, '"237" => "5", "243" => "4"');
-- select NewOrder(111, '67 Lakewood Way', 1, 0, 0, '"141" => "4", "145" => "5", "152" => "5"');
-- select NewOrder(233, '8060 Stephen Park', 2, 1, 0, '"245" => "4", "248" => "3"');
-- select NewOrder(4, '97550 Kipling Avenue', 1, 0, 0, '"3" => "3", "5" => "3", "10" => "3", "13" => "2"');
-- select NewOrder(366, '652 Novick Avenue', 2, 0, 0, '"312" => "3", "320" => "1"');
-- select NewOrder(294, '8 Butterfield Crossing', 2, 0, 0, '"222" => "2", "224" => "2"');
-- select NewOrder(243, '496 Portage Trail', 1, 1, 0, '"329" => "5", "333" => "3"');
-- select NewOrder(269, '22 8th Court', 3, 1, 0, '"86" => "3", "89" => "2", "90" => "1", "94" => "2"');
-- select NewOrder(381, '21 Welch Avenue', 2, 0, 0, '"39" => "3", "42" => "4", "49" => "3"');
-- select NewOrder(349, '23758 Northview Pass', 3, 0, 0, '"305" => "2", "318" => "1"');
-- select NewOrder(398, '4 Canary Street', 2, 0, 0, '"67" => "4"');
-- select NewOrder(266, '47312 Bartelt Pass', 3, 0, 0, '"219" => "2"');
-- select NewOrder(130, '881 Ilene Parkway', 2, 1, 0, '"176" => "2", "177" => "2", "187" => "1"');
-- select NewOrder(205, '026 Bonner Hill', 1, 0, 0, '"20" => "2", "23" => "1", "25" => "3", "26" => "2", "33" => "4"');
-- select NewOrder(69, '32 Tennyson Court', 2, 1, 0, '"244" => "4", "248" => "3", "253" => "3"');
-- select NewOrder(262, '7214 Old Gate Drive', 1, 1, 0, '"1" => "1", "2" => "1", "3" => "1", "6" => "1"');
-- select NewOrder(170, '78 Dottie Avenue', 3, 1, 0, '"308" => "2", "311" => "1", "318" => "1"');
-- select NewOrder(209, '688 Coolidge Place', 2, 0, 0, '"88" => "2", "92" => "3"');
-- select NewOrder(325, '495 Buhler Center', 1, 0, 0, '"41" => "4", "42" => "3", "49" => "3"');
-- select NewOrder(110, '570 Monica Drive', 3, 0, 0, '"304" => "3", "306" => "2"');
-- select NewOrder(152, '56191 Burning Wood Pass', 2, 0, 0, '"66" => "5"');
-- select NewOrder(267, '1337 Farmco Parkway', 1, 1, 0, '"222" => "2", "223" => "2", "224" => "1"');
-- select NewOrder(5, '04809 5th Road', 1, 0, 0, '"176" => "2", "177" => "2"');
-- select NewOrder(45, '1 Westport Point', 1, 0, 0, '"18" => "5", "19" => "5", "20" => "10", "30" => "5"');
-- select NewOrder(299, '3876 Blackbird Point', 2, 0, 0, '"244" => "5", "250" => "4"');
-- select NewOrder(257, '9825 Larry Terrace', 1, 0, 0, '"383" => "2", "389" => "3"');
-- select NewOrder(176, '84045 Helena Parkway', 3, 1, 0, '"380" => "5"');
-- select NewOrder(246, '84 Welch Terrace', 3, 0, 0, '"256" => "5", "258" => "4", "259" => "4", "262" => "3"');
-- select NewOrder(108, '48 Artisan Circle', 3, 1, 0, '"116" => "5", "118" => "3", "120" => "3"');
-- select NewOrder(18, '181 Bowman Street', 2, 1, 0, '"378" => "3", "380" => "1", "381" => "2"');
-- select NewOrder(208, '3 Crownhardt Place', 2, 1, 0, '"159" => "4", "167" => "6"');
-- select NewOrder(122, '53821 Lunder Point', 1, 0, 0, '"382" => "2", "386" => "2", "394" => "1", "395" => "1"');
-- select NewOrder(63, '06314 Buhler Place', 1, 0, 0, '"194" => "3", "200" => "2"');
-- select NewOrder(367, '441 Carioca Lane', 1, 0, 0, '"246" => "8"');
-- select NewOrder(400, '8 Hanson Place', 1, 1, 0, '"246" => "5", "249" => "6", "252" => "6"');
-- select NewOrder(144, '58484 Bunting Terrace', 2, 0, 0, '"256" => "5", "260" => "7"');
-- select NewOrder(274, '548 Lukken Pass', 2, 1, 0, '"113" => "4", "120" => "3", "122" => "2", "125" => "3"');
-- select NewOrder(399, '8 Thompson Way', 3, 1, 0, '"131" => "5", "157" => "4"');
-- select NewOrder(215, '7758 Pleasure Hill', 2, 1, 0, '"219" => "1", "220" => "1", "223" => "2"');
-- select NewOrder(157, '84379 Brown Plaza', 1, 1, 0, '"144" => "4", "145" => "3", "149" => "4"');
-- select NewOrder(316, '82 Artisan Circle', 2, 1, 0, '"88" => "6"');
-- select NewOrder(73, '860 Shelley Road', 2, 0, 0, '"310" => "3", "320" => "3"');
-- select NewOrder(121, '7349 Havey Avenue', 1, 0, 0, '"141" => "4", "142" => "3", "150" => "4", "157" => "4"');
-- select NewOrder(211, '4 Spohn Center', 2, 1, 0, '"228" => "4", "238" => "4", "242" => "3"');
-- select NewOrder(3, '05 Russell Avenue', 2, 0, 0, '"382" => "2", "390" => "3"');
-- select NewOrder(349, '23758 Northview Pass', 3, 0, 0, '"159" => "6"');
-- select NewOrder(247, '543 Lunder Lane', 2, 0, 0, '"368" => "5", "372" => "3", "377" => "3"');
-- select NewOrder(113, '60955 Summer Ridge Circle', 1, 0, 0, '"53" => "2", "56" => "3"');
-- select NewOrder(195, '572 Novick Park', 1, 0, 0, '"228" => "5", "239" => "7"');
-- select NewOrder(42, '27 Lake View Drive', 2, 1, 0, '"256" => "6", "258" => "5", "259" => "3", "263" => "5"');
-- select NewOrder(34, '63 Cottonwood Park', 2, 1, 0, '"339" => "5", "346" => "4", "359" => "3"');
-- select NewOrder(327, '4499 Rutledge Center', 5, 0, 0, '"265" => "4", "267" => "3", "274" => "4"');
-- select NewOrder(7, '4153 Carpenter Terrace', 1, 1, 0, '"287" => "4", "290" => "4"');
-- select NewOrder(159, '9753 Hooker Street', 1, 1, 0, '"68" => "2", "74" => "2", "75" => "1", "80" => "4"');
-- select NewOrder(78, '974 Maple Circle', 2, 1, 0, '"40" => "5", "48" => "6"');
-- select NewOrder(89, '95 Melby Parkway', 1, 1, 0, '"20" => "7", "26" => "10"');
-- select NewOrder(119, '1543 Farmco Road', 2, 1, 0, '"219" => "6"');
-- select NewOrder(250, '02547 Golden Leaf Parkway', 2, 1, 0, '"162" => "4", "165" => "3"');
